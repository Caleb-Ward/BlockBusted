    ...
    public class OrdersController : Controller
    {
                ...
                public ActionResult Index(string orderSearch, string startDate, string endDate, string orderSortOrder)
        {
                ...
                if (!String.IsNullOrEmpty(orderSearch))
                {
                 ...
                 o.OrderLines.Any(ol => ol.MovieTitle.Contains(orderSearch)));
                }
        ...
        public async Task<ActionResult> Review()
        {
            if (Request.IsAuthenticated)
            {
                ...
                foreach (var cartLine in cart.GetCartLines())
                {
                    ...
                    {
                        Movie = cartLine.Movie,
                        MovieID = cartLine.MovieID,
                        MovieTitle = cartLine.Movie.Title,
                        RentTime = cartLine.RentTime,
                        WeeklyPrice = cartLine.Movie.Price
                    };
